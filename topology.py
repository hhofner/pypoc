...
def grid(src_count=4, relay_count=8, dest_count=4, bandwidth=1e3):
    ...
    relay_nodes_src_side = [RestrictedNode(1, 1, None, 500, 625, 1e3) for _ in range(int(relay_count/2))]
    relay_nodes_dest_side = [RestrictedNode(1, 1, None, 500, 625, 1e3) for _ in range(int(relay_count/2))]
